...
#| fig.alt: Residual plot of the iris model
inzplot(iris.lm, which = "residual")
```

<img src="man/figures/README-example-1.png" alt="" width="50%" style="display: block; margin: auto;" />

``` r
#| fig.alt: Scale-location plot of the iris model
inzplot(iris.lm, which = "scale")
```

<img src="man/figures/README-example-2.png" alt="" width="50%" style="display: block; margin: auto;" />

``` r
#| fig.alt: Leverage plot of the iris model
inzplot(iris.lm, which = "leverage")
```

<img src="man/figures/README-example-3.png" alt="" width="50%" style="display: block; margin: auto;" />
